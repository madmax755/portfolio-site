  ...
  return (
    <div className="pt-20 pb-16 overflow-x-hidden">
      ...
      >
        ...
        <div className="border-l-4 border-electric pl-5 py-3 bg-panel/50 border-y border-r border-cream/10 max-w-3xl">
          <p className="text-xl text-cream/75 leading-relaxed font-semibold">
